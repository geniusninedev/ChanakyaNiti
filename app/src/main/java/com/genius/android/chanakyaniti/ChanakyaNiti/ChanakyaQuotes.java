...
public class ChanakyaQuotes extends AppCompatActivity
   ...
   ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chanakya_quotes);
...
*/
        ...
        String[] values = new String[] {  "Learn from the mistakes of others… you can’t live long enough to make them all yourselves"
...
"Someone who insults the Vedas, Shastras, intelligent, virtuous and peaceful persons, is a fool. In terms of wider interests of the society, such a person is maleficent in all ways, so its better to get rid of them for good."
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                R.layout.content_chanakya_quotes, R.id.textView1, values);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(ChanakyaQuotes.this,Quotopager.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i=new Intent(ChanakyaQuotes.this, SettingsActivity.class);
            startActivity(i);
            return true;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent i = new Intent(ChanakyaQuotes.this, Home.class);
            startActivity(i);

            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
            Intent i = new Intent(ChanakyaQuotes.this, AboutChanakya.class);
            startActivity(i);


        } else if (id == R.id.nav_slideshow) {
            Intent i = new Intent(ChanakyaQuotes.this, ChapterEnglish.class);
            startActivity(i);


        } else if (id == R.id.nav_manage) {
            Intent i = new Intent(ChanakyaQuotes.this, ChapterHindi.class);
            startActivity(i);


        }
        if (id == R.id.nav_about) {
            Intent i = new Intent(ChanakyaQuotes.this, ChanakyaQuotes.class);
            startActivity(i);
        }
